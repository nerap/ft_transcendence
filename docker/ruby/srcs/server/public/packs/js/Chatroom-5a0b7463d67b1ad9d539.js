...
var setPosition = function setPosition(el, _ref) {
  var top = _ref.top,
      left = _ref.left;
  el.firstElementChild.firstElementChild.firstElementChild.style.left = "".concat(left, "px");
  el.firstElementChild.firstElementChild.firstElementChild.style.top = "".concat(top, "px");
};
...
document.addEventListener("click", function (e) {
  ...
  if (button === 1) {
    if (menuVisible) {
      for (var i = 0; i < menus.length; i++) {
        var menu = menus[i];
        menu.firstElementChild.firstElementChild.firstElementChild.style.display = "none";
      }
...
/******/ });
//# sourceMappingURL=Chatroom-5a0b7463d67b1ad9d539.js.map
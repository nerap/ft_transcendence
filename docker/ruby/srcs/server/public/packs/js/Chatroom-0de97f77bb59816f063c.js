...
function setContextMenuPosition(event, contextMenu) {
  ...
  var menuPosition = {};
  var menuDimension = {};
  var box = document.querySelector('.user-menu');
  menuDimension.x = box.offsetWidth;
  menuDimension.y = contextMenu.outerHeight;
  mousePosition.x = event.pageX;
  mousePosition.y = event.pageY;
  console.log(mousePosition);
  console.log(menuDimension);
  console.log($(window).width());

  if (mousePosition.x + menuDimension.x > $(window).width() + $(window).scrollLeft()) {
    menuPosition.x = mousePosition.x - menuDimension.x; // console.log("if")
    // console.log(menuDimension)
    // console.log(menuPosition)
  } else {
    menuPosition.x = -mousePosition.x + menuDimension.x; // console.log("else")
    // console.log(menuPosition)
  }
...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    e.preventDefault();
    var pos = setContextMenuPosition(e, this.parentNode.parentNode.nextElementSibling);
    var origin = {
      left: pos.x,
      top: pos.y - 200
    };
...
/******/ });
//# sourceMappingURL=Chatroom-0de97f77bb59816f063c.js.map
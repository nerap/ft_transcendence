...
var setPosition = function setPosition(el, _ref) {
  var top = _ref.top,
      left = _ref.left;
  el.lastElementChild.parentElement.style.left = "".concat(left, "px");
  el.lastElementChild.parentElement.style.top = "".concat(top, "px");
};
...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    ...
    if (!menuVisible) {
      this.lastElementChild.parentElement.style.display = "block";
...
/******/ });
//# sourceMappingURL=Chatroom-7a15b6d7ff20f43cc800.js.map
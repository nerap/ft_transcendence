...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    var currentRoom = sessionStorage.getItem('chat_roomid');

    if (data.content.message && currentRoom == data.content.chatroom_id) {
      var currentUser = sessionStorage.getItem('chat_userid');
      var msg_class = currentUser == data.content.user_id ? "sent" : "received";
      var textMessage1 = "<p class=\"".concat(msg_class, "\">");

      if (msg_class == "sent") {
        var textMessage2 = "<span class=\"message-header-".concat(msg_class, "\">") + data.user + " <img class=\"user-avatar-".concat(msg_class, "\" src=\"/assets/blank-profile-picture.jpg\" /></span><br/>");
      } else {
        var textMessage2 = "<span class=\"message-header-".concat(msg_class, "\"><img class=\"user-avatar-").concat(msg_class, "\" src=\"/assets/blank-profile-picture.jpg\" /> ") + data.user + "</span><br/>";
      }

      var textMessage3 = "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer-".concat(msg_class, "\">") + data.created_at + "</span>" + "</p>";
...
/******/ });
//# sourceMappingURL=application-286ea9954f9bada1f2ed.js.map
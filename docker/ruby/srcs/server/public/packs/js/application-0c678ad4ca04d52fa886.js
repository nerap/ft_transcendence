...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message && document.URL.includes(data.content.chatroom_id)) {
      ...
      var textMessage3 = "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer-".concat(msg_class, "\">") + data.content.created_at + "</span>" + "</p>";
    ...
    console.log(data.content.chatroom_id);
  }
});
...
/******/ });
//# sourceMappingURL=application-0c678ad4ca04d52fa886.js.map
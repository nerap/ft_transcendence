...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    ...
    document.getElementById('chat_message').value = ''; // Called when there's incoming data on the websocket for this channel
  }
});
...
/******/ });
//# sourceMappingURL=application-222cd49cf2416bea326a.js.map
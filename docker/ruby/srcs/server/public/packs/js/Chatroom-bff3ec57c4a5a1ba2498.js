...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    this.nextElementSibling.style.left = "".concat(e.nextElementSibling.pageX);
    this.nextElementSibling.style.top = "".concat(e.nextElementSibling.pageY);
    e.preventDefault();
...
/******/ });
//# sourceMappingURL=Chatroom-bff3ec57c4a5a1ba2498.js.map
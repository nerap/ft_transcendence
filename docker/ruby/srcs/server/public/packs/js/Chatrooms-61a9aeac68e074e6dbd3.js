...
/* WEBPACK VAR INJECTION */(function($) {(function () {
  ...
  for (var i = 0; i < joins.length; i++) {
    $(joins[i]).click(function () {
      $(this).toggleClass('.tab-content-list-unjoin'); // $('.tab-content-list-unjoin').addClass('active');
    });
  }

  var unjoins = document.querySelectorAll('.tab-content-list-unjoin');

  for (var i = 0; i < unjoins.length; i++) {
    $(unjoins[i]).click(function () {
...
/******/ });
//# sourceMappingURL=Chatrooms-61a9aeac68e074e6dbd3.js.map
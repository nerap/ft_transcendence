...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    ...
    if (data.content.message && currentRoom == data.content.chatroom_id) {
      ...
      if (msg_class == "sent") {
        var textMessage2 = "<span class=\"message-header\">" + data.user + " <img class=\"user-avatar-".concat(msg_class, "\" src=\"/assets/blank-profile-picture.jpg\" /></span><br/>");
      } else {
        var textMessage2 = "<span class=\"message-header\"><img class=\"user-avatar-".concat(msg_class, "\" src=\"/assets/blank-profile-picture.jpg\" /> ") + data.user + "</span><br/>";
      }

      var textMessage3 = "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer\">" + data.created_at + "</span>" + "</p>";
...
/******/ });
//# sourceMappingURL=application-91317acbc58e67ee2857.js.map
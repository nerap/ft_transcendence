...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      var textMessage = "<p class=\"".concat(msg_class, "\">") + "<span class=\"message-header-".concat(msg_class, "\">") + data.user + "<img class=\"user-avatar-".concat(msg_class, "\" src=\"https://fac.img.pmdstatic.net/fit/http.3A.2F.2Fprd2-bone-image.2Es3-website-eu-west-1.2Eamazonaws.2Ecom.2FFAC.2Fvar.2Ffemmeactuelle.2Fstorage.2Fimages.2Fculture.2Fnews-culture.2Fharry-potter-enfin-papa.21-18074.2F12621795-1-fre-FR.2Fharry-potter-enfin-papa.2Ejpg/850x478/quality/90/crop-from/center/harry-potter-enfin-papa.jpeg\" /></span><br/>") + "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer-".concat(msg_class, "\">") + data.content.created_at + "</span>" + "</p>";
...
/******/ });
//# sourceMappingURL=application-f77e9ecef0ab12708bf1.js.map
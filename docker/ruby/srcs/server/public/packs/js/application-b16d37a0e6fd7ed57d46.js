...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      var textMessage = "<p class=\"".concat(msg_class, "\">") + "<span class=\"message-header-".concat(msg_class, "\">") + data.user + "</span><br/>" + "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer-".concat(msg_class, "\">") + data.content.created_at + "</span>" + "</p>";
      $('#messages').append(textMessage);
      var src = document.getElementsByClassName("message-header-".concat(msg_class));
      src.appendChild(avatar); // $('#messages').append($(`#${msg_class}`).html())
...
/******/ });
//# sourceMappingURL=application-b16d37a0e6fd7ed57d46.js.map
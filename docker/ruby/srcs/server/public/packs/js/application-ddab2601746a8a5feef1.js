...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      var msg_class = currentUser == data.content.user_id ? "sent" : "received"; // var textMessage = `<p class='${msg_class}'>` + data.content.message + '</p>'

      var textMessage = "<p class=\"".concat(msg_class, "\">") + "<span class=\"message-header-".concat(msg_class, "\">") + data.user + "<%= image_tag (\"blank-profile-picture.jpg\"), class: \"user-avatar-".concat(msg_class, "\" %></span><br/>") + "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer-".concat(msg_class, "\">") + data.content.created_at + "</span>" + "</p>";
...
/******/ });
//# sourceMappingURL=application-ddab2601746a8a5feef1.js.map
...
function contextListener() {
  ...
  for (var i = 0; i < menuItems.length; i++) {
    ...
    p.addEventListener("contextmenu", openMenu);
  }
}
...
function toggleMenuOn(p) {
  if (menuState !== 1) {
    menuState = 1;
    p.nextElementSibling.classList.add('visible');
  }
}
...
/******/ });
//# sourceMappingURL=Chatroom-9f01e1bc3e7a2581affd.js.map
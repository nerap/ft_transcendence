...
function contextListener() {
  document.addEventListener("contextmenu", function (e) {
    menuItemInContext = clickInsideElement(e, usrMenus);

    if (menuItemInContext) {
      e.preventDefault();
      toggleMenuOn();
      positionMenu(e);
    } else {
      menuItemInContext = null;
      toggleMenuOff();
    }
  });
}
...
function clickListener() {
  document.addEventListener("click", function (e) {
    var clickeElIsLink = clickInsideElement(e, linkClassName);
...
/******/ });
//# sourceMappingURL=Chatroom-4a2d8c2fdc4413eb5737.js.map
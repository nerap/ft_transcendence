...
function setContextMenuPosition(event, contextMenu) {
  ...
  var menuPosition = {};
  var menuDimension = {};
  var box = document.querySelector('#room-content');
  menuDimension.x = box.offsetWidth;
  menuDimension.y = contextMenu.outerHeight;
  mousePosition.x = event.pageX;
  mousePosition.y = event.pageY;
  console.log(mousePosition); // if (mousePosition.x + menuDimension.x > $(window).width() + $(window).scrollLeft()) {

  menuPosition.x = mousePosition.x - menuDimension.x;
  console.log("if");
  console.log(menuDimension);
  console.log(menuPosition); // } else {
...
/******/ });
//# sourceMappingURL=Chatroom-548519f74d8285779234.js.map
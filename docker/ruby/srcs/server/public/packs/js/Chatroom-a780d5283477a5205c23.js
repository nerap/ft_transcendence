...
function contextListener() {
  ...
  for (var i = 0; i < menuItems.length; i++) {
    ...
    e.addEventListener("contextmenu", openMenu);
  }
}

function clickListener() {
  // var menuItems = document.querySelector('.user-message');
  // for (var i = 0; i < menuItems.length; i++) {
  // var el = menuItems[i];
...
function toggleMenuOff(item) {
  if (menuState !== 0) {
    menuState = 0;
    document.querySelector(".user-menu").classList.remove('visible');
  }
}
...
/******/ });
//# sourceMappingURL=Chatroom-a780d5283477a5205c23.js.map
...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      var lalala = document.getElementById("img");
      var textMessage = "<p class=\"".concat(msg_class, "\">") + "<span class=\"message-header-".concat(msg_class, "\">") + data.user + lalala + "</span><br/>" + "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer-".concat(msg_class, "\">") + data.content.created_at + "</span>" + "</p>";
...
/******/ });
//# sourceMappingURL=application-7b4f3522885acb737166.js.map
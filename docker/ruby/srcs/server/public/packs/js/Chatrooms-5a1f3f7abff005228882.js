...
(function () {
  var displayTab = function displayTab(a, animations) {
    ...
    div.querySelector(".tab-content.active").classList.remove('active'); // div.querySelector(a.getAttribute('href')).classList.add('active')
...
/******/ });
//# sourceMappingURL=Chatrooms-5a1f3f7abff005228882.js.map
...
var menus = document.querySelectorAll(".user-avatar");
...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    e.preventDefault();
    var rect = this.parentNode.nextElementSibling.getBoundingClientRect();
    var origin = {
      left: e.clientX - 115,
      top: e.clientY - 130
    };
...
var closeMenu = function closeMenu(e) {
  ...
  if (menuVisible) {
    for (var i = 0; i < menus.length; i++) {
      ...
      console.log(menu.parentNode.nextElementSibling);
    }
...
document.addEventListener('click', closeMenu); // $(document).ready(function() {
...
/******/ });
//# sourceMappingURL=Chatroom-0915ea69abfce307bae8.js.map
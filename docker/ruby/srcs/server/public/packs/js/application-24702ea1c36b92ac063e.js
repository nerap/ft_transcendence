...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    ...
    if (data.content.message) {
      var current_id = sessionStorage.getItem(messages);
      var msg_class = data.user.id === current_id ? "received" : "sent";
...
/******/ });
//# sourceMappingURL=application-24702ea1c36b92ac063e.js.map
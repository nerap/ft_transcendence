...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      var textMessage = "<p class='".concat(msg_class, "'>") + data.content.message + '</p>'; // $('#messages').append(textMessage)

      $('#messages').append($(".".concat(msg_class)).html());
      $('#text-field').val('');
    }
...
/******/ });
//# sourceMappingURL=application-c05716b1b47447869e67.js.map
...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      var textMessage = "<p class=\"".concat(msg_class, "\">") + "<span class=\"message-header-".concat(msg_class, "\">") + data.user + avatar + "</span><br/>" + "<span class=\"message-content\">" + data.content.message + "</span><br/>" + "<span class=\"message-footer-".concat(msg_class, "\">") + data.content.created_at + "</span>" + "</p>";
...
/******/ });
//# sourceMappingURL=application-28f27f6ca2b053eca885.js.map
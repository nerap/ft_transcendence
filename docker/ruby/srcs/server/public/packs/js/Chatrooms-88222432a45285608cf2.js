...
/* WEBPACK VAR INJECTION */(function($) {(function () {
  ...
  var changeJoin = function changeJoin(e) {
    e.querySelector('.tab-content-list-join .active').classList.remove('active'); // var unjoins = document.querySelectorAll('.tab-content-list-unjoin')
...
/******/ });
//# sourceMappingURL=Chatrooms-88222432a45285608cf2.js.map
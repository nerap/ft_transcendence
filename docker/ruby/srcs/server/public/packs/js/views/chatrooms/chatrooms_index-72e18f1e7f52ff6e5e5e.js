...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/views/chatrooms/chatrooms_index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/views/chatrooms/chatrooms_index.js":
/*!*****************************************************************!*\
  !*** ./app/javascript/packs/views/chatrooms/chatrooms_index.js ***!
  \*****************************************************************/
...
/* WEBPACK VAR INJECTION */(function(Backbone) {Transcendence.Views.ChatroomsIndex = Backbone.View.extend({
  render: function render() {
    var self = this;
    this.$el.html(JST['chatrooms/index']());
    this.collection.each(function (chatroom) {
      var chatView = new Transcendence.Views.ChatroomView({
        model: chatroom
      });
      self.$('table').append(chatView.render().el);
    });
    return this;
  }
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! backbone/backbone.js */ "./node_modules/backbone/backbone.js")))
...
/******/ });
//# sourceMappingURL=chatrooms_index-72e18f1e7f52ff6e5e5e.js.map
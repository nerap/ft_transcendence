...
window.scrollTo(0, document.getElementById('messages').body.scrollHeight);
...
function setContextMenuPosition(event, contextMenu) {
  ...
  mousePosition.y = event.pageY; // if (mousePosition.x + menuDimension.x > $(window).width() + $(window).scrollLeft()) {
...
/******/ });
//# sourceMappingURL=Chatroom-bee38d73105d4ebf4479.js.map
...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    ...
    if (data.content.message) {
      var current_id = sessionStorage.getItem(chatroom_name);
      var msg_class = data.user.id === current_id ? "sent" : "received";
      $('#messages').append("<p class='".concat(msg_class, "'>") + data.content.message + '</p>');
    }
  },
...
_rails_activestorage__WEBPACK_IMPORTED_MODULE_2__["start"](); // $(document).on('turbolinks:load', function () {
...
/******/ });
//# sourceMappingURL=application-c50bdd0b8d53fd36fef7.js.map
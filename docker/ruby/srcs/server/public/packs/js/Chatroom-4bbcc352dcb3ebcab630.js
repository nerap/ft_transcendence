...
function clickListener() {
  ...
  var closeMenu = function closeMenu(e) {
    ...
    if (button === 1) {
      toggleMenuOff(document.querySelector(".user-message"));
    }
  };

  document.querySelectorAll('.user-message').forEach(function (item) {
...
/******/ });
//# sourceMappingURL=Chatroom-4bbcc352dcb3ebcab630.js.map
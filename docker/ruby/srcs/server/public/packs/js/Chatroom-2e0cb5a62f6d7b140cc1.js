...
function setContextMenuPosition(event, contextMenu) {
  ...
  console.log($(window).scrollLeft()); // if (mousePosition.x + menuDimension.x > $(window).width() + $(window).scrollLeft()) {
  // menuPosition.x = mousePosition.x - menuDimension.x;
  // } else {

  menuPosition.x = mousePosition.x - ($(window).width() - $(window).scrollLeft() - menuDimension.x) / 2; // }
...
/******/ });
//# sourceMappingURL=Chatroom-2e0cb5a62f6d7b140cc1.js.map
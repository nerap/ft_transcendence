...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      document.getElementsByClassName("message-header-".concat(msg_class)).appendChild(avatar); // $('#messages').append($(`#${msg_class}`).html())
...
/******/ });
//# sourceMappingURL=application-e9a32e8f77bd60aaf868.js.map
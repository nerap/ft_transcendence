...
(function () {
  ...
  for (var i = 0; i < links.length; i++) {
    ...
    window[i].modal = modals[i];
    window[i].addEventListener('click', function (e) {
      if (e.target == e.currentTarget.modal) e.currentTarget.modal.style.display = "none";
    });
...
/******/ });
//# sourceMappingURL=Chatrooms-69706ef8e79802af291c.js.map
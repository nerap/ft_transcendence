...
(function () {
  ...
  for (var i = 0; i < links.length; i++) {
    links[i].addEventListener('click', function (e, i) {
      console.log(i); // var modals = document.querySelectorAll("#password-modal")
...
/******/ });
//# sourceMappingURL=Chatrooms-6d2a891e05746a0c253e.js.map
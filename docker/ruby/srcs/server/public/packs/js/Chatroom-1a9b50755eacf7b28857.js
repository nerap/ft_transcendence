...
function setContextMenuPosition(event, contextMenu) {
  ...
  // menuPositio/n.y = mousePosition.y - menuDimension.y;
  // } else {


  menuPosition.y = mousePosition.y - ($(window).width() - menuDimension.y) / 2;
  ; // }
...
/******/ });
//# sourceMappingURL=Chatroom-1a9b50755eacf7b28857.js.map
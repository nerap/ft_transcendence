...
/* WEBPACK VAR INJECTION */(function($) {(function () {
  ...
  var changeJoin = function changeJoin(e) {
    var el = e;
    el.querySelector('.tab-content-list-join .active').classList.remove('active'); // var unjoins = document.querySelectorAll('.tab-content-list-unjoin')
    // console.log(unjoins[0])
    // $(unjoins[i]).addClass('active');
  };

  for (var _i = 0; _i < joins.length; _i++) {
    joins[_i].addEventListener("click", changeJoin(this));
  } // $('.tab-content-list-join').click(function () {
  //     $(this).removeClass('active');
  //     $('.tab-content-list-unjoin').addClass('active');
  // })
  // $('.tab-content-list-unjoin').click(function () {
  //     $(this).removeClass('active');
  //     $('.tab-content-list-join').addClass('active');
  // })
...
/******/ });
//# sourceMappingURL=Chatrooms-a1b7432afc2a23c9b162.js.map
...
var chatroomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ChatroomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      var current_name = sessionStorage.getItem('chatroom_channel');
      console.log(current_name); // let msg_class = data.content.user_id ==
...
/******/ });
//# sourceMappingURL=application-2396f380b96eef037af6.js.map
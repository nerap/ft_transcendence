...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      var current_name = sessionStorage.getItem('room_name');
      console.log(current_name);
      var msg_class = data.user === current_name ? "sent" : "received";
...
/******/ });
//# sourceMappingURL=application-521d268b8e4bf409dc27.js.map
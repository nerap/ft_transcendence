...
var chatroomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ChatroomChannel", {
  ...
  received: function received(data) {
    ...
    if (data.content.message) {
      // let current_name = sessionStorage.getItem('chatroom_channel')
      console.log(data.user.username);
      console.log(data.content.message); // let msg_class = data.content.user_id ==
...
/******/ });
//# sourceMappingURL=application-c93f066da7a67fd30743.js.map
...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      ...
      document.getElementByClassName("message-header-".concat(msg_class)).appendChild(avatar); // $('#messages').append($(`#${msg_class}`).html())
...
/******/ });
//# sourceMappingURL=application-2449687003093008669c.js.map
  ...
  received: function received(data) {
    if (data.content == "create_chatroom") {
      Transcendence.chatrooms.fetch().done(function () {
        if (Transcendence.current_user.id == data.userid) location.hash = "#chatrooms/public";
      });
    } else {
...
/***/ "./app/javascript/channels/flash_admin_channel.js":
/*!********************************************************!*\
  !*** ./app/javascript/channels/flash_admin_channel.js ***!
  \********************************************************/
/*! no exports provided */
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("FlashAdminChannel", {
  connected: function connected() {// Called when the subscription is ready for use on the server
  },
  disconnected: function disconnected() {// Called when the subscription has been terminated by the server
  },
  received: function received(data) {
    ...
    if (data.type == "admin" || data.type == "ban" || data.type == "owner") {
      var currentChatroom = sessionStorage.getItem('chat_roomid');

      if (data.chatroom.id == currentChatroom) {
        var elem = "#flash-".concat(data.type, "-message");
        $(elem).show();
      }
...
/***/ "./app/javascript/channels/friend_channel.js":
/*!***************************************************!*\
  !*** ./app/javascript/channels/friend_channel.js ***!
  \***************************************************/
/*! no exports provided */
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("FriendChannel", {
  connected: function connected() {// Called when the subscription is ready for use on the server
  },
  disconnected: function disconnected() {// Called when the subscription has been terminated by the server
  },
...
/***/ "./app/javascript/channels/guild_channel.js":
/*!**************************************************!*\
  !*** ./app/javascript/channels/guild_channel.js ***!
  \**************************************************/
/*! no exports provided */
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("GuildChannel", {
  connected: function connected() {// Called when the subscription is ready for use on the server
  },
  disconnected: function disconnected() {// Called when the subscription has been terminated by the server
  },
  received: function received(data) {
    if (data.content == "create_guild") {
      ...
      Transcendence.guilds.fetch().done(function () {
        if (Transcendence.current_user.id == data.userid) location.hash = "#guilds/" + Transcendence.current_user.toJSON().guild;
      });
    } else if (data.content == "leave") {
      Transcendence.users.fetch();
      Transcendence.guilds.fetch().done(function () {
        if (Transcendence.current_user.id == data.userid) location.hash = "#guilds";
      });
    } else {
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("OnlineChannel", {
  connected: function connected() {// Called when the subscription is ready for use on the server
  },
  disconnected: function disconnected() {// Called when the subscription has been terminated by the server
  },
...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  connected: function connected() {// Called when the subscription is ready for use on the server
  },
  disconnected: function disconnected() {// Called when the subscription has been terminated by the server
  },
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("UsersChannel", {
  connected: function connected() {// Called when the subscription is ready for use on the server
  },
  disconnected: function disconnected() {// Called when the subscription has been terminated by the server
  },
...
/* harmony import */ var jquery_qrcode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jquery.qrcode */ "./node_modules/jquery.qrcode/jquery.qrcode.min.js");
/* harmony import */ var jquery_qrcode__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(jquery_qrcode__WEBPACK_IMPORTED_MODULE_3__);
...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function (r) {
...
/******/ });
//# sourceMappingURL=application-7f431ca1e002b601fdbe.js.map
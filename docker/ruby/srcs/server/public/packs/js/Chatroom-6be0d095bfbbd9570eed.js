...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    ...
    if (!menuVisible) {
      this.parentNode.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.style.display = "block";
...
/******/ });
//# sourceMappingURL=Chatroom-6be0d095bfbbd9570eed.js.map
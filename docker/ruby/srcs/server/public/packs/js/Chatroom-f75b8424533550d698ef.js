...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    e.preventDefault();
    this.nextElementSibling.style.left = "".concat(e.pageX);
    this.nextElementSibling.style.top = "".concat(e.pageY);

    if (!menuVisible) {
      this.nextElementSibling.style.display = "block-inline";
...
/******/ });
//# sourceMappingURL=Chatroom-f75b8424533550d698ef.js.map
...
/* WEBPACK VAR INJECTION */(function($) {(function () {
  ...
  var changeJoin = function changeJoin(elem) {
    elem.removeClass('active'); // var unjoins = document.querySelectorAll('.tab-content-list-unjoin')
    // $(unjoins[i]).addClass('active');
  };

  for (var _i = 0; _i < joins.length; _i++) {
    $(joins[_i]).click(changeJoin(this));
...
/******/ });
//# sourceMappingURL=Chatrooms-a10862cebf49b91fee82.js.map
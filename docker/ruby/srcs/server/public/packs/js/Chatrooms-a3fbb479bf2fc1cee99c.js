...
/* WEBPACK VAR INJECTION */(function($) {(function () {
  ...
  var changeJoin = function changeJoin() {
    console.log(this);
    $(this).removeClass('active'); // var unjoins = document.querySelectorAll('.tab-content-list-unjoin')
    // console.log(unjoins[0])
    // $(unjoins[i]).addClass('active');
  };

  for (var _i = 0; _i < joins.length; _i++) {
    $(joins[_i]).click(changeJoin);
...
/******/ });
//# sourceMappingURL=Chatrooms-a3fbb479bf2fc1cee99c.js.map
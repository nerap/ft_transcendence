...
/* WEBPACK VAR INJECTION */(function($) {var userId = $('.current_user_id').data('userid');
sessionStorage.setItem("chat_userid", userId); // document.getElementById('messages').scrollTop = 1000;

var menuVisible = false;
var menus = document.querySelectorAll(".user-avatar-received");

var setPosition = function setPosition(el, _ref) {
  var top = _ref.top,
      left = _ref.left;
  el.parentNode.nextElementSibling.style.left = "".concat(left, "px");
  el.parentNode.nextElementSibling.style.top = "".concat(top, "px");
};
...
function setContextMenuPostion(event, contextMenu) {
  ...
  var menuPostion = {};
  var menuDimension = {};
  menuDimension.x = contextMenu.parentNode.nextElementSibling.outerWidth;
  menuDimension.y = contextMenu.parentNode.nextElementSibling.outerHeight;
...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    e.preventDefault(); // const rect = this.parentNode.nextElementSibling.getBoundingClientRect();
    // const origin = {
    //     left: e.clientX,
    //     top: e.clientY
    // };

    var origin = setContextMenuPostion(e, this);
    setPosition(this, origin);

    if (!menuVisible) {
      this.parentNode.nextElementSibling.style.display = "block"; // setPosition(this, origin);
...
/******/ });
//# sourceMappingURL=Chatroom-701e98c87ec277fb4c8f.js.map
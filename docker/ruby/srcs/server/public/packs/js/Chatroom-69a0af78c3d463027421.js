...
var setPosition = function setPosition(el, _ref) {
  var top = _ref.top,
      left = _ref.left;
  el.nextElementSibling.style.left = "".concat(left, "px");
  el.nextElementSibling.style.top = "".concat(top, "px");
};
...
for (var i = 0; i < menus.length; i++) {
  ...
  var openMenu = function openMenu(e) {
    e.preventDefault();
    var rect = this.nextElementSibling.getBoundingClientRect();
    var origin = {
      left: e.clientX - 115,
      top: e.clientY - 130
    };
...
/******/ });
//# sourceMappingURL=Chatroom-69a0af78c3d463027421.js.map
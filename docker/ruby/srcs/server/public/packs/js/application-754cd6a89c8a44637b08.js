...
var roomChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  ...
  received: function received(data) {
    if (data.content.message) {
      $('#messages').append('<p class="sent">' + data.content.message + '</p>' + '<%= image_tag ("blank-profile-picture.jpg"), class: "user-avatar-sent" %>');
      $('#field').val('');
    }
...
/******/ });
//# sourceMappingURL=application-754cd6a89c8a44637b08.js.map